...
public class PersistenceProperties
{
	...
	/**
	 * Procura por propriedades que irão sobrescrever o persistence.xml. A procura é feita na pasta home do usuário, em variáveis de ambiente e em propriedades
	...
	/**
	 * Verifica a existência de um arquivo jdbc.properties na pasta home do usuário. Caso exista, ele irá ler as propriedades que estão dentro dele.
	 * 
	 * A chave das propriedades desse arquivo devem ser iguais ao nome da propriedade do persistence.xml que se deseja sobreescrever.
	 * 
	 * @return Properties propriedades que irão sobrescrever o persistence.xml
	 * @throws Exception
	 */
	...
	/**
	 * Verifica a existência de variáveis de ambiente que serão usadas para sobrescrever as propriedades do persistence.xml.
	 * 
	 * A variável de ambiente para url, usuário e senha devem ter o mesmo nome dos valores das propriedades estáticas {@link #JDBC_URL}, {@link #JDBC_USER} e
	...
	/**
	 * Verifica a existência de um parâmetro Java passado na inicialização da aplicação. Esse parâmetro deve se chamar "jdbc-file", portanto será passado dessa
	 * forma "-Djdbc-file=/caminho/jdbc.properites".
	 * 
	 * A chave das propriedades desse arquivo devem ser iguais ao nome da propriedade do persistence.xml que se deseja sobreescrever.
	 * 
	 * @return Properties propriedades que irão sobrescrever o persistence.xml
	...
	/**
	 * Verifica a existência de propriedades Java que serão usadas para sobrescrever as propriedades do persistence.xml.
	 * 
	 * A propriedade Java para url, usuário e senha devem ter o mesmo nome dos valores das propriedades estáticas {@link #JDBC_URL}, {@link #JDBC_USER} e
	 * {@link #JDBC_PASSWORD} respectivamente.
	 * 
